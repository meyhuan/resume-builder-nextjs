...
export interface AppState {
  ...
  /** Toggle whether the job intention text is rendered in template headers. */
  setHeaderJobIntentionVisibility: (visible: boolean) => void
  /** Reset resume content and history to a blank new-resume state. */
  resetResume: () => void
  /** Load test data into the editor. */
  loadTestData: () => void
  /** Load a specific template QA scenario into the editor. */
  loadScenarioData: (resume: ResumeData) => void
