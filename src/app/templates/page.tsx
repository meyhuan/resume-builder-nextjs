...
const PAGE_DESCRIPTION: string = '提供最新、专业的极简简历模板，覆盖 AI 产品经理、大模型应用工程师、AIGC 运营、前端开发、产品经理等岗位。支持免费开始制作、一键智能生成，首份 PDF 可导出。';
...
export const metadata: Metadata = {
  ...
  keywords: ['极简简历模板', '简历模板免费', '免费简历在线制作', 'AI新职业简历模板', 'AI产品经理简历', '大模型应用工程师简历', 'AIGC运营简历', '产品经理简历', '秋招简历在线模版', '首份免费导出PDF', '智简简历'],
  alternates: {
