...
function ModuleChip({ module }: { readonly module: ModuleConfig }): ReactElement {
  ...
  return (
    ...
    >
      ...
      <span className="flex-1 min-w-0 text-sm text-slate-700 truncate">{module.label}</span>
...
/**
 * List-module chip: on click, creates a new block then jumps straight to the
 * item detail page, skipping the intermediate list page.
 */
