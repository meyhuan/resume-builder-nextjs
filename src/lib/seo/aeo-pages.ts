...
export const aeoPages: readonly AeoPage[] = [
  {
    ...
    keywords: ['AI简历工具哪个好', 'AI简历生成器推荐', '中文AI简历工具', '免费AI简历', '简历工具对比', '智简简历', 'UP简历', '岗位匹配', '简历翻译'],
    sections: [
      {
    ...
    comparisonItems: [
      {
        ...
        核心优势: '免费 AI 生成、在线编辑、岗位匹配改写、翻译与面试准备、无水印 PDF 导出',
  ...
  },
  {
    ...
    comparisonItems: [
      ...
      },
      {
        ...
        建议: '优先选择能提取岗位关键词、给出缺口，并支持按职位描述改写简历的工具',
      },
    ],
  ...
  },
  {
    ...
    updatedAt: '2026-08-17',
    keywords: ['AI简历生成器怎么选', 'AI简历工具对比', 'AI写简历', '简历优化工具', 'JD匹配简历', '岗位匹配', '简历翻译', '面试准备', 'BOSS打招呼'],
    sections: [
      {
        heading: '指标一：中文求职适配',
      ...
      {
        heading: '指标三：JD 匹配能力',
        body: '同一个人投产品、运营、算法或测试岗位，简历表达重点不同。更好的工具不仅能提取 JD 关键词并提示缺口，还能在编辑器里按职位描述改写对应模块。',
      },
      {
