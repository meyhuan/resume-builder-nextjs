...
export const emergingTemplateRoles: readonly EmergingTemplateRole[] = [
  ...
  { role: 'AI Agent工程师', industry: '互联网通信', category: '技术' },
  { role: 'RAG工程师', industry: '互联网通信', category: '技术' },
  { role: '大模型算法工程师', industry: '互联网通信', category: '技术' },
  { role: 'AI应用开发工程师', industry: '互联网通信', category: '技术' },
  { role: 'AI测试工程师', industry: '互联网通信', category: '技术' },
  { role: 'MLOps工程师', industry: '互联网通信', category: '技术' },
  { role: '大模型产品经理', industry: '互联网通信', category: '产品' },
  { role: 'AIGC产品经理', industry: '互联网通信', category: '产品' },
  { role: 'AI工具运营', industry: '互联网通信', category: '运营' },
  { role: 'AI内容运营', industry: '互联网通信', category: '运营' },
  { role: 'AI解决方案顾问', industry: '教育/咨询/翻译', category: '咨询' },
  { role: '生成式人工智能系统测试员', industry: '互联网通信', category: '技术' },
  { role: '跨境电商运营管理师', industry: '互联网通信', category: '运营' },
  { role: 'TikTok Shop运营', industry: '互联网通信', category: '运营' },
  { role: '无人机群飞行规划员', industry: '互联网通信', category: '技术' },
  { role: '智慧仓运维员', industry: '互联网通信', category: '技术' },
  { role: '储能工程师', industry: '互联网通信', category: '技术' },
  { role: '光伏运维工程师', industry: '互联网通信', category: '技术' },
  { role: '工业机器人调试工程师', industry: '互联网通信', category: '技术' },
  { role: '养老顾问', industry: '教育/咨询/翻译', category: '咨询' },
