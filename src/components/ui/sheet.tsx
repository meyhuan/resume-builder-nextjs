...
const SheetHeader = ({
  ...
  <div
    className={cn('flex flex-col space-y-1.5 px-6 pt-6 pb-4 shrink-0', className)}
    {...props}
  />
);
...
const SheetFooter = ({
  ...
  <div
    className={cn('flex items-center gap-3 px-6 py-4 border-t border-slate-100 shrink-0', className)}
    {...props}
  />
);
