...
/** 手机 / Phone */
export function IconPhone(): ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" width={ICON_SIZE} height={ICON_SIZE}>
...
/** 性别 / Gender */
export function IconGender(): ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" width={ICON_SIZE} height={ICON_SIZE}>
...
/** 年龄/生日 / Age/Birthday */
export function IconAge(): ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" width={ICON_SIZE} height={ICON_SIZE}>
...
/** 所在地 / Location */
export function IconLocation(): ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" width={ICON_SIZE} height={ICON_SIZE}>
...
/** 工作年限 / Work years */
export function IconWorkYear(): ReactElement {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" width={ICON_SIZE} height={ICON_SIZE}>
