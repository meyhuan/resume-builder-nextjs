...
export const JsonLd = () => {
  const webApplicationSchema = {
    ...
    name: SITE_NAME,
    url: SITE_URL,
    description: '可免费开始使用的 AI 简历制作工具 —— 支持电脑网页与微信小程序，提供智能生成、可视化编辑、岗位匹配、翻译、面试准备和多格式导出。由独立开发者打造，帮你免费制作一份可投递简历。',
    ...
    offers: {
      ...
      price: '0',
      priceCurrency: 'CNY',
      description: '基础制作可免费开始使用，免费额度内的 PDF 导出按平台规则提供',
    },
    featureList: [
      'AI 智能简历生成',
