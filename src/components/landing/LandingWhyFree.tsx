...
const PROMISES = [
  ...
  },
  {
    ...
    title: "隐私安全",
    description:
      "你的简历数据只属于你。不会被用于训练 AI，不会被分享给第三方。",
  },
  {
  ...
  },
  {
    ...
    title: "真人支持",
    description:
      "遇到任何问题，通过公众号随时找到我。不是客服机器人，是开发者本人。",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-10 items-center">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3 text-base text-slate-600 leading-8">
              <p>你好，我是智简简历的开发者。</p>
              <p>
            ...
            <Link href="/ai">
              <LandingButton
                size="lg"
                className="rounded-full shadow-lg shadow-violet-500/30 text-base px-7 mt-2"
              >
                免费生成简历
              </LandingButton>
            </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {PROMISES.map((item, index) => (
              <div
                key={index}
                className="group p-5 rounded-2xl border border-slate-100 bg-white hover:shadow-lg hover:shadow-violet-500/5 hover:-translate-y-1 transition-all duration-500"
              >
                <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
                  {item.icon}
                </div>
