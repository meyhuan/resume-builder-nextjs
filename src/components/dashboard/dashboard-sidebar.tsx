...
import { FileText, MessageSquareHeart, Crown, Sparkles, Download, ClipboardList, UserRoundPen } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'application-profile', label: '网申资料', href: '/dashboard/application-profile', icon: <UserRoundPen className="w-[18px] h-[18px]" /> },
  { key: 'applications', label: '投递管理', href: '/dashboard/applications', icon: <ClipboardList className="w-[18px] h-[18px]" /> },
