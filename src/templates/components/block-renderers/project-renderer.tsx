...
export interface ProjectRendererProps extends BaseRendererProps {
 ...
 * 项目经历渲染器 - 支持多种视觉风格
 */
export default function ProjectRenderer(props: ProjectRendererProps): ReactElement {
          ...
          <div className="flex-1">
            ...
            {block.role ? (
              <p className="text-sm text-gray-600 mt-1 ml-4">
                <EditableFieldWrapper blockId={block.id} fieldName="role" value={block.role} onUpdate={(): void => {}} />
              </p>
            ) : null}
          </div>
          <div
