...
export interface EducationRendererProps extends BaseRendererProps {
 ...
 * 教育经历渲染器 - 支持多种视觉风格
 */
export default function EducationRenderer(props: EducationRendererProps): ReactElement {
        ...
        <div className="flex justify-between items-start mb-2">
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mt-1 ml-4">
              <EditableFieldWrapper blockId={block.id} fieldName="major" value={block.major} onUpdate={(): void => {}} />
              <span className="text-gray-400">
                {' · '}
                <EditableFieldWrapper blockId={block.id} fieldName="degree" value={block.degree} onUpdate={(): void => {}} />
              </span>
            </p>
          </div>
          <div
