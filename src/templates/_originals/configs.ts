...
export const CONFIG: Record<VariantId, VariantConfig> = {
  ...
  lifeng: { id: 'lifeng', accent: '#7c3aed', secondary: '#111827', ink: '#111827', muted: '#64748b', bleed: true, layout: 'dark-sidebar', density: 'compact' },
  qingsui: { id: 'qingsui', accent: '#0891b2', secondary: '#7c3aed', ink: '#0f172a', muted: '#475569', bleed: true, layout: 'campus', metrics: 'campus', heroTone: 'gradient' },
