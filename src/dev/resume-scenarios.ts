...
export const RESUME_SCENARIOS: readonly ResumeScenario[] = [
  ...
  },
  {
    id: 'portfolio',
    name: '图片作品集附页',
    description: '混合竖图和横图，测试作品集自动分组、分页、说明与 PDF 输出。',
    resume: {
      ...compactResume,
      id: 'scenario-portfolio',
      portfolio: {
        enabled: true,
        title: '设计作品集',
        images: [
          {
            ...
            url: '/avatar.jpg',
            objectKey: 'fixtures/avatar-1.jpg',
            width: 768,
            height: 1024,
            caption: '人物视觉与品牌形象练习',
            sortOrder: 0,
          },
          {
            ...
            url: '/avatar_transpant.png',
            objectKey: 'fixtures/avatar-2.png',
            width: 768,
            height: 1024,
            caption: '透明背景人物素材处理',
            sortOrder: 1,
          },
          {
            ...
            url: '/m/pc-editor-preview.png',
            objectKey: 'fixtures/editor-preview.png',
            width: 2590,
            height: 1725,
            caption: 'AI 简历编辑器界面设计',
            sortOrder: 2,
          },
          {
            id: 'portfolio-image-4',
            url: '/logo-aijianli.png',
            objectKey: 'fixtures/logo.png',
            width: 500,
            height: 150,
            caption: '品牌标志应用',
            sortOrder: 3,
