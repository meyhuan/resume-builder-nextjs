...
export const BLANK_RESUME_JSON: ExternalResume = {
  ...
  self_evaluation: {
    content: '<p>Keep this section brief. Summarize your experience and strengths, highlighting qualities that match the target role. Avoid excessive adjectives. Example: Strong communication and coordination skills, adaptable to new environments, proficient in office software and document management.</p>',
    is_hide: false,
  },
  intern: [],
  school_exps: [],
